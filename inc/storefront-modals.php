...
function storev1_render_storefront_modals() {
    ...
    echo '<div class="sv1-checkout-login-banners"><button type="button" class="sv1-checkout-login-banner is-active" data-sv1-auth-switch="login"><img src="' . esc_url(get_template_directory_uri() . '/assets/account-login-illustration.webp') . '" alt="Ilustração de login" loading="lazy"><strong>Já sou cliente</strong><span>Entrar na minha conta</span></button><button type="button" class="sv1-checkout-login-banner" data-sv1-auth-switch="register"><img src="' . esc_url(get_template_directory_uri() . '/assets/account-register-illustration.webp') . '" alt="Ilustração de cadastro" loading="lazy"><strong>Ainda não tenho conta</strong><span>Criar cadastro agora</span></button></div></div>';
    echo '<div class="sv1-checkout-auth-views">';
    echo '<form class="sv1-checkout-login-form" data-sv1-checkout-login-form data-sv1-auth-view="login" novalidate><label for="sv1-checkout-login-email">E-mail</label><input id="sv1-checkout-login-email" type="email" data-sv1-login-email autocomplete="email" required><label for="sv1-checkout-login-password">Senha</label><input id="sv1-checkout-login-password" type="password" data-sv1-login-password autocomplete="current-password" required><label class="sv1-checkout-login-remember"><input type="checkbox" data-sv1-login-remember> Lembrar acesso neste dispositivo</label><button type="submit" class="sv1-checkout-login-submit">Entrar e continuar a compra</button><div class="sv1-checkout-login-actions"><button type="button" data-sv1-auth-switch="register">Criar conta</button><button type="button" data-sv1-auth-switch="recover">Recuperar senha</button></div><button type="button" class="sv1-checkout-login-secondary" data-sv1-login-close>Continuar como visitante</button></form>';
    ...
    echo '<label for="sv1-register-password">Crie uma senha</label><input id="sv1-register-password" name="password" type="password" autocomplete="new-password" minlength="8" required><button type="submit" class="sv1-checkout-login-submit">Criar conta e continuar</button><button type="button" class="sv1-checkout-login-secondary" data-sv1-auth-switch="login">Já tenho conta: entrar</button></form>';
    echo '<form class="sv1-checkout-login-form" data-sv1-checkout-recover-form data-sv1-auth-view="recover" hidden novalidate><label for="sv1-recover-email">E-mail cadastrado</label><input id="sv1-recover-email" name="email" type="email" autocomplete="email" required><p class="sv1-checkout-auth-help">Enviaremos um link seguro para você criar uma nova senha.</p><button type="submit" class="sv1-checkout-login-submit">Enviar link de recuperação</button><button type="button" class="sv1-checkout-login-secondary" data-sv1-auth-switch="login">Voltar para o login</button></form>';
